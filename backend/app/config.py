...
class Settings:
    profile: str = os.getenv("EVOVOICE_PROFILE", "remote-server")
    host: str = os.getenv("EVOVOICE_HOST", "0.0.0.0")
    port: int = _int_env("EVOVOICE_PORT", 30190)

    openai_base_url: str = os.getenv("EVOWIT_OPENAI_BASE_URL", "http://100.64.0.3:50553/v1").rstrip("/")
    ...
    tts_voice: str = os.getenv("DELL_TTS_VOICE", "voxcpm:auto")
